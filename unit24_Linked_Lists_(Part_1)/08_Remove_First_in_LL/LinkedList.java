...
public int removeFirst() {
  ...
  head = head.next; // means now head will point to next data, when head started pointing to next Node, then first Node will automatically remove
  size--;
  return val;
}
